...
//********** modification! :: import HFT namespace
using HFT;

using System.Runtime.InteropServices.ComTypes;
using IBApi;

//********** modification! :: change namespace to HFT
namespace HFT
{
    //! [ewrapperimpl]
    public class EWrapperImpl : EWrapper
    {
        ...
        //********** modification! :: add form1 object as main form
        public Form1 myform;
        ...
        public virtual void tickPrice(int tickerId, int field, double price, TickAttrib attribs)
        {
            ...
            //********** modification! :: Add this tick price to the form by calling the AddListBoxItem delegate
            ...
            //********** modification! :: Create a string to send to the form
        ...
        public virtual void tickSize(int tickerId, int field, decimal size)
        {
            ...
            //********** modification! :: Add this tick size to the form by calling the AddTickSizeItem delegate
        ...
        public virtual void tickString(int tickerId, int tickType, string value)
        {
            ...
            //********** modification! :: Add this tick string to the form by calling the AddListViewItemTickString delegate
        ...
        public virtual void historicalData(int reqId, Bar bar)
        {
            ...
            // ********** modification! :: Add this historical data to the form by calling the AddItemHistoricalData delegate
        ...
        public virtual void scannerData(int reqId, int rank, ContractDetails contractDetails, string distance, string benchmark, string projection, string legsStr)
        {
            ...
            //********** modification! :: Add this scanner data to the form by calling the AddScannerItemScanner delegate
